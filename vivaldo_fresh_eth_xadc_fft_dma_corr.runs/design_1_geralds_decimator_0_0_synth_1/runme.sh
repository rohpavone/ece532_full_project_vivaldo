...
HD_PWD='/nfs/ug/homes-1/t/tramblei/vivaldo_fresh_eth_xadc_fft_dma_corr/vivaldo_fresh_eth_xadc_fft_dma_corr.runs/design_1_geralds_decimator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_geralds_decimator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_geralds_decimator_0_0.tcl
