...
HD_PWD='/nfs/ug/homes-1/t/tramblei/vivaldo_fresh_eth_xadc_fft_dma_corr/vivaldo_fresh_eth_xadc_fft_dma_corr.runs/design_1_rst_mig_7series_0_81M_0_synth_1'
cd "$HD_PWD"
