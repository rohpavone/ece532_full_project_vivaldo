...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(M_AXIS_RESULT_tdata, M_AXIS_RESULT_tlast, 
  M_AXIS_RESULT_tready, M_AXIS_RESULT_tuser, M_AXIS_RESULT_tvalid, aclk, 
  event_data_in_channel_halt, event_data_out_channel_halt, event_frame_started, 
  event_status_channel_halt, event_tlast_missing, event_tlast_unexpected, fft_valid, 
  s_axis_data, s_axis_last, s_axis_ready, s_axis_tvalid)
/* synthesis syn_black_box black_box_pad_pin="M_AXIS_RESULT_tdata[31:0],M_AXIS_RESULT_tlast,M_AXIS_RESULT_tready,M_AXIS_RESULT_tuser[0:0],M_AXIS_RESULT_tvalid,aclk,event_data_in_channel_halt,event_data_out_channel_halt,event_frame_started,event_status_channel_halt,event_tlast_missing,event_tlast_unexpected,fft_valid,s_axis_data[11:0],s_axis_last,s_axis_ready,s_axis_tvalid" */;
